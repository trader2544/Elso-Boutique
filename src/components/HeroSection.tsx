      ...
      <div className="container mx-auto px-4 relative z-10 h-full">
        <div className="flex items-center h-full">
          ...
          <div className="text-left max-w-xl pb-8 md:pb-8">
            ...
            {/* Buttons */}
            <div className="mb-3 md:mb-6 flex flex-col gap-2 md:flex-row md:gap-4">
              <Link to="/about" className="w-auto md:w-auto">
                <Button 
                  size="sm" 
                  className="bg-gradient-to-r from-pink-400 to-pink-300 hover:from-pink-500 hover:to-pink-400 text-white px-4 py-2 md:px-8 md:py-3 rounded-full font-semibold text-xs md:text-base shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-pink-200 h-8 md:h-auto"
                >
                  About Us
                </Button>
              </Link>
              ...
              >
                <Button 
                  size="sm" 
                  className="bg-gradient-to-r from-green-500 to-green-400 hover:from-green-600 hover:to-green-500 text-white px-4 py-2 md:px-8 md:py-3 rounded-full font-semibold text-xs md:text-base shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-green-200 h-8 md:h-auto"
                >
                  Contact
                </Button>
              </a>
