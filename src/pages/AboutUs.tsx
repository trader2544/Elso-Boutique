...
import { MapPin, Phone, Mail, Clock, Instagram, Heart, Sparkles, Star, ShoppingBag, MessageCircle, Users, Video } from "lucide-react";
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-4 md:py-8 relative z-10">
        <Button
          variant="ghost"
          onClick={() => navigate("/")}
          className="mb-4 md:mb-6 bg-white/20 backdrop-blur-md hover:bg-white/30 text-pink-700 font-medium border border-white/30"
        >
          ← Back to Home
        </Button>
        ...
        <div className="text-center mb-8 md:mb-12">
          <div className="flex justify-center items-center mb-4 md:mb-6">
            <Sparkles className="w-6 h-6 md:w-8 md:h-8 text-pink-500 mr-2 md:mr-3" />
            <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold bg-gradient-to-r from-pink-600 via-purple-600 to-rose-600 bg-clip-text text-transparent">
              ESLO Boutique
            </h1>
            <Sparkles className="w-6 h-6 md:w-8 md:h-8 text-pink-500 ml-2 md:ml-3" />
          </div>
          <p className="text-base md:text-lg lg:text-xl text-gray-700 max-w-2xl mx-auto font-medium px-4">
        ...
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-8">
          ...
          <Card className="bg-white/30 backdrop-blur-lg border border-white/40 shadow-2xl overflow-hidden relative">
            ...
            <CardHeader className="bg-gradient-to-r from-pink-200/50 to-purple-200/50 backdrop-blur-md relative border-b border-white/30">
              <CardTitle className="text-xl md:text-2xl font-bold text-pink-800 flex items-center">
                <Heart className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-pink-600" />
                Our Story
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-8 relative">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="flex items-center space-x-4 pt-2 md:pt-4">
                    <div className="flex items-center">
                      ...
                      <Star className="w-4 h-4 md:w-5 md:h-5 text-yellow-400 fill-current" />
                      <Star className="w-4 h-4 md:w-5 md:h-5 text-yellow-400 fill-current" />
                      <span className="ml-2 text-xs md:text-sm text-gray-700 font-semibold">Premium Quality</span>
                    </div>
                  </div>
                  
                  {/* Social Media Links */}
                  <div className="pt-2 md:pt-4">
                    <h4 className="text-base md:text-lg font-semibold text-gray-800 mb-3">Follow Us:</h4>
                ...
                <div className="flex justify-center mt-6 lg:mt-0">
                  <div className="w-64 h-64 md:w-80 md:h-80 rounded-3xl overflow-hidden shadow-2xl border-4 border-white/50 backdrop-blur-sm">
                    <img
          ...
          <Card className="bg-white/30 backdrop-blur-lg border border-white/40 shadow-2xl overflow-hidden relative">
            ...
            <CardHeader className="bg-gradient-to-r from-purple-200/50 to-pink-200/50 backdrop-blur-md relative border-b border-white/30">
              <CardTitle className="text-xl md:text-2xl font-bold text-purple-800 flex items-center">
                <ShoppingBag className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-purple-600" />
            ...
            <CardContent className="p-4 md:p-8 relative">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-4 md:space-y-6">
                  <div className="bg-gradient-to-r from-purple-100/60 to-pink-100/60 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-white/40">
                    <div className="flex items-center mb-3 md:mb-4">
                      <Users className="w-5 h-5 md:w-6 md:h-6 text-purple-600 mr-2" />
                      <h3 className="font-bold text-purple-700 text-base md:text-lg">Wholesale Benefits</h3>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-pink-100/60 to-rose-100/60 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-white/40">
                    <h4 className="font-bold text-pink-700 mb-3 text-base md:text-lg">Minimum Order Requirements</h4>
                ...
                <div className="bg-white/40 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-white/50">
                  <h3 className="font-bold text-gray-800 mb-4 text-base md:text-lg">Request Bulk Quote</h3>
                  <form onSubmit={handleBulkOrderSubmit} className="space-y-4">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 shadow-lg text-sm md:text-base"
                    >
          ...
          <Card className="bg-white/30 backdrop-blur-lg border border-white/40 shadow-2xl overflow-hidden relative">
            ...
            <CardHeader className="bg-gradient-to-r from-rose-200/50 to-pink-200/50 backdrop-blur-md relative border-b border-white/30">
              <CardTitle className="text-xl md:text-2xl font-bold text-rose-800 flex items-center">
                <MessageCircle className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-rose-600" />
                Get In Touch
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-8 relative">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-pink-100/60 to-rose-100/60 backdrop-blur-md rounded-2xl border border-white/40">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <MapPin className="w-5 h-5 md:w-6 md:h-6 text-white" />
                    </div>
                    <div>
                      <p className="font-bold text-gray-900 text-sm md:text-base">Location</p>
                      <p className="text-gray-700 text-sm md:text-base">Kisumu, Kenya 🇰🇪</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-purple-100/60 to-pink-100/60 backdrop-blur-md rounded-2xl border border-white/40">
                    ...
                    <div>
                      <p className="font-bold text-gray-900 text-sm md:text-base">Phone</p>
                      <p className="text-gray-700 text-sm md:text-base">+254 745 242 174</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-rose-100/60 to-pink-100/60 backdrop-blur-md rounded-2xl border border-white/40">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-rose-500 to-pink-500 rounded-full flex items-center justify-center flex-shrink-0">
                      <Mail className="w-5 h-5 md:w-6 md:h-6 text-white" />
                    </div>
                    <div>
                      <p className="font-bold text-gray-900 text-sm md:text-base">Email</p>
                      <p className="text-gray-700 text-sm md:text-base">elsokisumu@gmail.com</p>
                    </div>
                  </div>

                  <div className="p-4 md:p-6 bg-gradient-to-br from-purple-100/60 to-pink-100/60 backdrop-blur-md rounded-2xl border border-white/40">
                    <div className="flex items-center mb-3 md:mb-4">
                      <Clock className="w-5 h-5 md:w-6 md:h-6 text-purple-600 mr-2" />
                      <h3 className="font-bold text-purple-700 text-sm md:text-base">Opening Hours</h3>
                    </div>
                    <div className="space-y-2 text-gray-700 text-sm md:text-base">
                      <p>📅 Monday to Saturday</p>
                      <p className="text-base md:text-lg font-semibold text-purple-600">9:00 AM – 6:00 PM</p>
                      <p>📅 Sunday</p>
                      <p className="text-base md:text-lg font-semibold text-purple-600">10:00 AM – 4:00 PM</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Contact Form */}
                <div className="bg-white/40 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-white/50">
                  <h3 className="font-bold text-gray-800 mb-4 text-base md:text-lg">Send us a Message</h3>
                  <form onSubmit={handleContactSubmit} className="space-y-4">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 shadow-lg text-sm md:text-base"
                    >
                      <MessageCircle className="w-4 h-4 mr-2" />
                      Send Message
                    </Button>
      ...
      <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white p-3 md:p-4 rounded-full shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center group backdrop-blur-md"
        ...
        >
          ...
          <span className="ml-2 hidden group-hover:block text-xs md:text-sm font-medium whitespace-nowrap">Chat with us!</span>
        </a>
      </div>
    </div>
  );
