      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            We'd love to hear from you! Get in touch with us for any questions, concerns, or just to say hello.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <Card className="shadow-lg border-pink-100">
              <CardHeader className="bg-gradient-to-r from-pink-50 to-purple-50">
                <CardTitle className="text-2xl text-pink-700">Get in Touch</CardTitle>
              </CardHeader>
              <CardContent className="pt-6 space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Serving Kisumu and surrounding areas</p>
                  </div>
                </div>
            ...
            <Card className="shadow-lg border-pink-100">
              <CardHeader className="bg-gradient-to-r from-pink-50 to-purple-50">
                <CardTitle className="text-xl text-pink-700">Follow Us</CardTitle>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="flex space-x-4">
                  <a
                    href="https://www.tiktok.com/@elso.kisumu?_t=ZM-8u2XKlIX9bq&_r=1"
                    target="_blank"
                  ...
                  <a
                    href="https://www.instagram.com/elso.kisumu/profilecard/?igsh=MTlrYWd0dnN1anR4dA=="
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gray-100 hover:bg-pink-100 p-3 rounded-full transition-colors"
                  >
          ...
          <Card className="shadow-lg border-pink-100">
            <CardHeader className="bg-gradient-to-r from-pink-50 to-purple-50">
              <CardTitle className="text-2xl text-pink-700">Send us a Message</CardTitle>
            </CardHeader>
            <CardContent className="pt-6">
